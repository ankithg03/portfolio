...
export default function TextDipserse({
  ...
  return (
    <motion.div
      ...
      className="box text-arrival flex justify-between font-Poppins text-white text-[18vw] md:text-[14vw] lg:text-[10vw] font-bold p-10 ankith-text -mt-28 md:-mt-10 banner-text"
