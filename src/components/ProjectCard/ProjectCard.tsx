    ...
    <div className={clsx("rounded-lg shadow-md p-4 flex flex-col", s['project-card'])}>
      ...
      <div className='mt-4 mb-auto text-center font-PPMori'>
        ...
        <div className='flex gap-2 text-center justify-center'>
            {project.github && (
                <><a href={project.github} target="_blank" rel="noopener noreferrer" className="text-blue-500 font-PPMori-bold hover:underline font-bold">
                View on GitHub
                </a>{project?.link ? " | " : ""}</>
            )}
            {project.link && (
                <a href={project.link} target="_blank" rel="noopener noreferrer" className="text-blue-500 font-PPMori-bold  hover:underline font-bold">
                Live Demo
                </a>
            )}
            </div>
